  ...
  return <main className={styles.shell}>
    <aside className={styles.sidebar}>
      ...
      <nav aria-label="Dashboard sections">
        <a className={styles.active} href="#overview"><span>▦</span>Overview</a><a href="#funnel"><span>↗</span>Acquisition</a><a href="#retention"><span>↻</span>Retention</a><a href="#audit"><span>◈</span>Tracking audit</a>
      </nav>
    ...
    <section className={styles.content}>
      <header className={styles.header}><div><p className={styles.eyebrow}>Growth command center</p><h1>Revenue, retention, and leaks — in one view.</h1></div><button className={styles.refresh} onClick={refreshData} disabled={loading}><span>↻</span> {loading ? "Syncing…" : "Refresh live data"}</button></header>
